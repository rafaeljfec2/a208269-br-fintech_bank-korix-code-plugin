...
const GrepSchema = z.object({
  ...
  paths: z.array(z.string()).optional().describe('Specific paths to search (default: workspace root)'),
  ignoreCase: z.boolean().optional().describe('Case insensitive search (default: true)'),
  contextLines: z.number().optional().describe('Number of context lines before/after match'),
  ...
  excludePaths: z.array(z.string()).optional().describe('Paths to exclude (e.g., ["node_modules"])'),
});
